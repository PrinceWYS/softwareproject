                ...
                {src && src.map((item, index) => 
                    {return (
                        <tr key={index}>
                            ...
                            <td>
                                <Link to="./prescription">药单详情</Link>
                            </td>
                            <td>
                                <Link to={"./edit/"+item.MR_id}>查看详情</Link>
                            </td>
                        </tr>
                    )
                })}
...
function LoadMedicalRecords(path, setSrc) {
    Axios.get(path, {
        params: {patient_ID: localStorage.getItem('token')}
    })
