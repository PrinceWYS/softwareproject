...
function WebStyle(props) {
    ...
    return (
        <div className='page-body'>
            <button className='btn btn-success' onClick={_upImg}>
                {
                    imgState?'上传':'重新上传'
                }
            </button>
            ...
            <input id='upimg' type='file' style={{ display: 'none' }} accept='jpg/jpeg/png' onChange={upChange} />
        </div>
    )
}
...
class WebStylec extends Component{
    ...
    render(){
        return(
            <div className='page-body'>
            <button className='btn btn-success' onClick={this._upImg}>
                {
            ...
            <input id='upimg' type='file' style={{ display: 'none' }} accept='jpg/jpeg/png' onChange={this.upChange} />
        </div>
        )
            }
}
